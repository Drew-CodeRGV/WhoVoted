...
def identify_sign_ai(filepath):
    """Use AI to identify the yard sign candidate. Returns (candidate_name, confidence)."""
    # TODO: Integrate Claude Vision API
    # For now, return None (will be marked for manual review)
    # When implemented:
    # 1. Send image to Claude Vision
    # 2. Prompt with known candidate list
    # 3. Parse response
    return None, 0
