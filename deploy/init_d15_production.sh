#!/bin/bash
# Initialize D15 database with sample data on production server

echo "Initializing D15 election results table with sample data..."

ssh -i whovoted-key.pem ubuntu@politiquera.com << 'EOF'
sudo -u ubuntu python3 << 'PYTHON'
import sqlite3
...
echo "Dashboard should now display results at https://politiquera.com/d15"
